						...
						<div class="tab-content mt-4">
						  <div class="tab-pane active" id="HR" role="tabpanel" aria-labelledby="HR-tab">
							      ...
							      <div class="form-group row">
							        ...
							        <div class="col-8">
							          <select id="category" name="category" class="custom-select" required="required" onchange="changeText(this,1)">
							            <option value="Culture" <?=($projects['category']=='Culture')?'selected':''?>><?=$language["croatian"]['edit.culture']?></option>
							            <option value="Public" <?=($projects['category']=='Public')?'selected':''?>><?=$language["croatian"]['edit.public']?></option>
							            <option value="Business" <?=($projects['category']=='Business')?'selected':''?>><?=$language["croatian"]['edit.business']?></option>
							            <option value="Interior" <?=($projects['category']=='Interior')?'selected':''?>><?=$language["croatian"]['edit.interior']?></option>
							            <option value="House" <?=($projects['category']=='House')?'selected':''?>><?=$language["croatian"]['edit.house']?></option>
							            <option value="Tenders" <?=($projects['category']=='Tenders')?'selected':''?>><?=$language["croatian"]['edit.tender']?></option>
							          </select>
							        </div>
							      </div>
							      <div class="form-group row">
							        ...
							        <div class="col-8">
							          <select id="featured" name="featured" class="custom-select" required="required" onchange="changeText(this,1)">
							            <option value="1" <?=($projects['featured']==1)?'selected':''?>><?=$language["croatian"]['edit.active']?></option>
							            <option value="0" <?=($projects['featured']==0)?'selected':''?>><?=$language["croatian"]['edit.inactive']?></option>
							          </select>
							        </div>
							      </div>
							      <div class="form-group row">
							        ...
							        <div class="col-8">
							          <select id="product" name="product" class="custom-select" required="required" onchange="changeText(this,1)">
							            <option value="1" <?=($projects['product']==1)?'selected':''?>><?=$language["croatian"]['edit.active']?></option>
							            <option value="0" <?=($projects['product']==0)?'selected':''?>><?=$language["croatian"]['edit.inactive']?></option>
							          </select>
							        </div>
							      </div>
							      <div class="form-group row">
							        ...
							        <div class="col-8">
							          <select id="slideshowimage" name="slideshowimage" class="custom-select" required="required" onchange="changeText(this,1)">
							            <option value="1" <?=($projects['slideshowimage']==1)?'selected':''?>><?=$language["croatian"]['edit.active']?></option>
							            <option value="0" <?=($projects['slideshowimage']==0)?'selected':''?>><?=$language["croatian"]['edit.inactive']?></option>
							          </select>
							        </div>
							      </div>
							      <div class="form-group row">
							        ...
							        <div class="col-8">
							          <select id="finest" name="finest" class="custom-select" required="required" onchange="changeText(this,1)">
							            <option value="1" <?=($projects['finest']==1)?'selected':''?>><?=$language["croatian"]['edit.active']?></option>
							            <option value="0" <?=($projects['finest']==0)?'selected':''?>><?=$language["croatian"]['edit.inactive']?></option>
							          </select>
							        </div>
							      </div>
							      <div class="form-group row">
							        ...
							        <div class="col-8">
							          <select id="status" name="status" class="custom-select" required="required" onchange="changeText(this,1)">
							            <option value="1" <?=($projects['status']==1)?'selected':''?>><?=$language["croatian"]['edit.active']?></option>
							            <option value="0" <?=($projects['status']==0)?'selected':''?>><?=$language["croatian"]['edit.inactive']?></option>
							          </select>
							        </div>
							      </div>
									<div class="form-group row">
							...
							<div class="form-group row">
								...
								<div class="col-10">
								  <textarea id="text" name="text" cols="40" rows="5" class="form-control" style="overflow:auto" onchange="changeText(this,1)"><?=$projects['text']?></textarea>
								</div>
							</div>
						  </div>
						  <div class="tab-pane" id="EN" role="tabpanel" aria-labelledby="EN-tab">
							      ...
							      <div class="form-group row">
							        ...
							        <div class="col-8">
							          <select id="ecategory" name="ecategory" class="custom-select" required="required" onchange="changeText(this,2)">
							            <option value="Culture" <?=($projects['category']=='Culture')?'selected':''?>><?=$language["english"]['edit.culture']?></option>
							            <option value="Public" <?=($projects['category']=='Public')?'selected':''?>><?=$language["english"]['edit.public']?></option>
							            <option value="Business" <?=($projects['category']=='Business')?'selected':''?>><?=$language["english"]['edit.business']?></option>
							            <option value="Interior" <?=($projects['category']=='Interior')?'selected':''?>><?=$language["english"]['edit.interior']?></option>
							            <option value="House" <?=($projects['category']=='House')?'selected':''?>><?=$language["english"]['edit.house']?></option>
							            <option value="Tenders" <?=($projects['category']=='Tenders')?'selected':''?>><?=$language["english"]['edit.tender']?></option>
							          </select>
							        </div>
							      </div> 
							      <div class="form-group row">
							        ...
							        <div class="col-8">
							          <select id="efeatured" name="efeatured" class="custom-select" required="required" onchange="changeText(this,2)">
							            <option value="1" <?=($projects['featured']==1)?'selected':''?>><?=$language["english"]['edit.active']?></option>
							            <option value="0" <?=($projects['featured']==0)?'selected':''?>><?=$language["english"]['edit.inactive']?></option>
							          </select>
							        </div>
							      </div>
							      <div class="form-group row">
							        ...
							        <div class="col-8">
							          <select id="eproduct" name="eproduct" class="custom-select" required="required" onchange="changeText(this,2)">
							            <option value="1" <?=($projects['product']==1)?'selected':''?>><?=$language["english"]['edit.active']?></option>
							            <option value="0" <?=($projects['product']==0)?'selected':''?>><?=$language["english"]['edit.inactive']?></option>
							          </select>
							        </div>
							      </div>
							      <div class="form-group row">
							        ...
							        <div class="col-8">
							          <select id="eslideshowimage" name="eslideshowimage" class="custom-select" required="required" onchange="changeText(this,2)">
							            <option value="1" <?=($projects['slideshowimage']==1)?'selected':''?>><?=$language["english"]['edit.active']?></option>
							            <option value="0" <?=($projects['slideshowimage']==0)?'selected':''?>><?=$language["english"]['edit.inactive']?></option>
							          </select>
							        </div>
							      </div>
							      <div class="form-group row">
							        ...
							        <div class="col-8">
							          <select id="efinest" name="efinest" class="custom-select" required="required" onchange="changeText(this,2)">
							            <option value="1" <?=($projects['finest']==1)?'selected':''?>><?=$language["english"]['edit.active']?></option>
							            <option value="0" <?=($projects['finest']==0)?'selected':''?>><?=$language["english"]['edit.inactive']?></option>
							          </select>
							        </div>
							      </div>
							      <div class="form-group row">
							        ...
							        <div class="col-8">
							          <select id="estatus" name="estatus" class="custom-select" required="required" onchange="changeText(this,2)">
							            <option value="1" <?=($projects['status']==1)?'selected':''?>><?=$language["english"]['edit.active']?></option>
							            <option value="0" <?=($projects['status']==0)?'selected':''?>><?=$language["english"]['edit.inactive']?></option>
							          </select>
							        </div>
							      </div>
									<div class="form-group row">
							...
							<div class="form-group row">
								<label for="text" class="col-2 col-form-label"><?=$language["croatian"]['db.description']?></label> 
								<div class="col-10">
								  <textarea id="etext" name="etext" cols="40" rows="5" class="form-control" style="overflow:auto"><?=$projects['etext']?></textarea>
								</div>
							</div>
						  </div>
			...
			<script type="text/javascript">
				...
				$('#editpage').on('submit', function(e){
					...
					{  
						...
						$.ajax({  
							url:"<?=base_url('home/multipleImageStore?id='.$projects['id'])?>",
							method:"POST",  
							data:form_data,  
							contentType: false,  
							cache: false,  
					...
					}
					{
				        ...
				        $.ajax({
				        	url: "<?=base_url('home/saveclick?id='.$projects['id'])?>",
				        	method:"POST",
				        	data:form_data,
				        	success:function(res) 
				        	{
