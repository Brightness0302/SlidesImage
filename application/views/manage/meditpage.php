						...
						<div class="form-group row">
							...
							<div class="col-6">
								<div class="form-group row">
									...
									<div class="col-6">
										<img class="col-md-8 border border-danger" id="uploadimage" src="<?=file_exists("assets/studio/".$projects['id'].".jpg")?base_url('assets/studio/'.$projects['id'].'.jpg'):base_url('assets/studio/plus.png')?>">
									</div>
								</div>
								<style type="text/css">
									input[type="file"] {
			...
			<script type="text/javascript">
				...
				$('#editpage').on('submit', function(e){
					...
					}
					{
				        ...
				        $.ajax({
				        	url: "<?=base_url('home/msaveclick?id='.$projects['id'])?>",
				        	method:"POST",
				        	data:form_data,
				        	success:function(res) 
				        	{
