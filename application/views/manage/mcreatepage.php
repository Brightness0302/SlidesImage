										      ...
										      <div class="form-group row">
										        ...
										        <div class="col-8">
											      <div class="input-group">
											        ...
											        <input id="etitle" name="etitle" type="text" class="form-control" required="required">
											      </div>
											    </div>
										      </div>
										      <div class="form-group row">
										        ...
										        <div class="col-8">
										          <div class="input-group">
										            ...
										            <input id="eyear" name="eyear" type="text" class="form-control">
										          </div>
										        </div>
										      </div>
										      <div class="form-group row">
										        <label for="description" class="col-4 col-form-label"><?=$language["croatian"]['mproj.description']?></label> 
										        <div class="col-8">
										          <textarea id="edescription" name="edescription" cols="40" rows="5" class="form-control"></textarea>
										        </div>
										      </div>
											</div>
								  		</div>
				        ...
				        $.ajax({
				        	...
				        	success:function(res) 
				        	{
								...
								{  
									...
									$.ajax({  
										url:"<?=base_url('home/singleImageStore?id=')?>"+id,
										method:"POST",  
										data:form_data,  
										contentType: false,  
										cache: false,  
