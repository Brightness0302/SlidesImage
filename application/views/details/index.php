		...
		<section class="page-header bg-color-light-scale-1 page-header-md" style="padding:15px 0;background:#fff!important;margin-bottom:20px">
			<div class="container">
				<div class="row align-items-center">
					...
					<div class="col-2">
						<a href="<?=base_url((($this->session->userdata('language')=="english")?"en":"hr")."/details/$prev[id]")?>" class="portfolio-prev text-decoration-none d-block appear-animation" data-appear-animation="fadeInRightShorter">
					...
					<div class="col-2">
						<a href="<?=base_url((($this->session->userdata('language')=="english")?"en":"hr")."/details/$next[id]")?>" class="portfolio-next text-decoration-none d-block float-end appear-animation" data-appear-animation="fadeInLeftShorter">
